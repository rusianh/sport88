...
public class Mail {
    public String doEmailVerification(String email) throws MessagingException, UnsupportedEncodingException {
        ...
        String body = "Welcome to SPORT88, your email verification code is: " + randomNumber;
        this.sendEmail(email, "Email Verification Sport88", body);
        return randomNumber;
    }
    public String resetPw(String email) throws MessagingException, UnsupportedEncodingException {
        String randomNumber = getRandomNumberString();
        String body = "Welcome to SPORT88, your new password is: " + randomNumber;
    ...
    private void sendEmail(String toEmail, String subject, String body) throws UnsupportedEncodingException, MessagingException {
        final String fromEmail = "sport88app@gmail.com";
        // Mat khai email cua ban
        final String password = "1234567s89$";
        ...
        msg.setFrom(new InternetAddress(fromEmail, "SPORT88"));
